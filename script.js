document.addEventListener("DOMContentLoaded", () => {
    ...
    // Check if a custom password exists in localStorage, otherwise use default
    ...
    changePwdForm.addEventListener("submit", (e) => {
        ...
        if (cpUsername.value === storedUser && cpOldPassword.value === storedPass) {
            ...
            cpMsg.style.color = "#2ea44f";
            cpMsg.textContent = "Password updated successfully! You can now log in.";
            cpMsg.style.display = "block";
